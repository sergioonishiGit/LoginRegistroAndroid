...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewHolder.bt_registrar = findViewById(R.id.bt_login_cadastrar);
        ...
        mViewHolder.bt_entrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.isEmpty() || password.isEmpty()){
                    Toast.makeText(LoginActivity.this, "Favor inserir o Username e a Password", Toast.LENGTH_SHORT).show();
                } else {
                    // Validar com base de dados se login é ou não valido
                    int res =  db.Utilizador_login(username, password);
                    if(res > 0){
                        Intent intent = new Intent(LoginActivity.this, MinhaContaActivity.class);
